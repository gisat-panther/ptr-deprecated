...
class Deprecated_MapControls extends React.PureComponent {
...
Deprecated_MapControls.defaultProps = {
    activeMapKey: '',
    navigator: {},
    setNavigator: () => {},
    resetHeading: () => {},
...
Deprecated_MapControls.propTypes = {
...
export default Deprecated_MapControls;